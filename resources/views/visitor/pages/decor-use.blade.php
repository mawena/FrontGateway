...
@section('base.body')
    <section class="bg-white overflow-hidden space position-relative bg-top-center" id="blog-sec"
        ...
        <div class="container">
            ...
            <div class="mt-5 pt-5">
                <div class="px-4 py-3 rounded shadow mb-2 bg-white" id="chooseBar" style="display: none">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <label id="reselectImageBtn" style="cursor: pointer" class="th-btn style2 m-0 th-icon border text-dark" for="imageInput">
                                <span class="">
                                    <span class="me-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" style="width: 20px; height:20px" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="mb-1">
                ...
                <label style="cursor: pointer" class="shadow bg-white rounded mb-4" for="imageInput" id="imgLabel">
                    <div style="width: 100%; height: 50vh;" class="d-flex align-items-center justify-content-center">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" style="width: 100px; height:100px" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                              </svg>
                              <br>
            ...
            <canvas id="canvas" class="shadow bg-white rounded mb-4" width="800" height="600" style="display: none;"></canvas>
            <!-- Modal -->
