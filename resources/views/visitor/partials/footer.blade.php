                    ...
                    <div class="widget footer-widget">
                        ...
                        <div class="th-widget-contact">
                            <div class="info-box_text">
                                <div class="icon"><img src="/visitor/assets/img/icon/phone.svg"
                                        alt="img"></div>
                                <div class="details">
                            ...
                            <div class="info-box_text">
                                <div class="icon"><img src="/visitor/assets/img/icon/envelope.svg"
                                        alt="img"></div>
                                <div class="details">
                            ...
                            <div class="info-box_text">
                                <div class="icon"><img src="/visitor/assets/img/icon/location-dot.svg"
                                        alt="img"></div>
                                <div class="details">
                ...
                <div class="col-md-6 col-xl-auto">
                    <div class="widget footer-widget">
                        ...
                        <div class="sidebar-gallery">
                            <div class="gallery-thumb"><img src="/visitor/assets/img/widget/gallery_1_1.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="/visitor/assets/img/widget/gallery_1_2.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="/visitor/assets/img/widget/gallery_1_3.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="/visitor/assets/img/widget/gallery_1_4.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="/visitor/assets/img/widget/gallery_1_5.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                            <div class="gallery-thumb"><img src="/visitor/assets/img/widget/gallery_1_6.jpg"
                                    alt="Gallery Image"> <a target="_blank" href="https://www.instagram.com/"
                                    class="gallery-btn"><i class="fab fa-instagram"></i></a></div>
                        </div>
                    </div>
		...
		<div class="container">
			<div class="row justify-content-between align-items-center">
				<div class="col-md-12 text-center text-dark">
					<p class="copyright-text text-dark">Copyright 2024 <a
							href="{{ route('visitor.events') }}">{{ config('app.name') }}</a>. All Rights
						Reserved.</p>
				</div>
			</div>
		</div>
