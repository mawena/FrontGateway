            ...
            <div class="row">
                <div class="col-7 align-self-center">
                    <h2 class="page-title text-truncate text-dark font-weight-medium mb-1">
                        Modification du promoteur / {{ $promoter['name'] }}</h2>
                </div>
                        ...
                        <div class="card-body">
                            <div class="modal-body">
                                <div class="text-center mt-2 mb-4">
                                    <a href="{{ route('admin.promoter.index') }}" class="text-success">
                                ...
                                <form class="pl-3 pr-3" action="{{ route('admin.promoter.update', $promoter['id']) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
									<div class="row">
										<div class="col-lg-6 col-md-12">
											<div class="form-group">
												...
												<input class="form-control" name="name" id="name" required=""
													placeholder="" value="{{ $promoter['name'] }}">
												@error('name')
										...
										<div class="col-lg-6 col-md-12">
											<div class="form-group">
												...
												<input class="form-control" type="email" name="email" id="email"
													required="" placeholder="" value="{{ $promoter['email'] }}">
												@error('email')
													<span class="text-danger">{{ $message }}</span>
												@enderror
											</div>
										...
										<div class="col-lg-6 col-md-12">
											<div class="form-group">
												...
												<input class="form-control" name="promoter.structure" type="text" required=""
													id="structure" placeholder="" value="{{ $promoter['promoter']['structure'] }}">
										...
										<div class="col-lg-6 col-md-12">
											<div class="form-group">
												...
												<input class="form-control" name="promoter.phone_number" type="text"
													required="" id="phone_number" placeholder=""
													value="{{ $promoter['promoter']['phone_number'] }}">
										...
										<div class="col-lg-6 col-md-12">
											<div class="form-group">
												...
												<input class="form-control" name="promoter.birth_date" type="date" required=""
													...
													value="{{ $promoter['promoter']['birth_date'] }}">
                                    ...
                                    <input type="hidden" value="{{ $promoter['profile'] }}" name="profile">
