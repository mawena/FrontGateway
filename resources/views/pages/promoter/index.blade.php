					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex align-items-center mb-4">
								...
								<div class="ml-auto">
									@can(['create'], 'promoter', session('userData'))
											...
											<tr class="text-center">
												...
												<td style="max-width: 100px">
													@can(['read'], 'promoter', session('userData'))
														<a href="{{ route('admin.promoter.show', $user['id']) }}" class="btn text-primary"><i
																class="fa fa-eye"></i></a>
													@endcan
													@can(['edit'], 'promoter', session('userData'))
														<a href="{{ route('admin.promoter.edit', $user['id']) }}" class="btn text-warning"><i
																class="fa fa-edit"></i></a>
													@endcan
													@can(['delete'], 'promoter', session('userData'))
