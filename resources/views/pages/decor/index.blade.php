									...
									<tbody>
										@foreach ($decors as $decor)
											<tr class="py-0 text-center">
												...
												<td class="py-4" class="text-bold">{{ $decor['event']['promoter']['user']['name'] }}</td>
												...
												<td class="" style="max-width: 100px">
													...
													<a href="{{ route('admin.decor.destroy', $decor['id']) }}" class="btn">
													</a>
												</td>
											</tr>
										@endforeach
						...
						<div class="modal-body">
							...
							<form class="pl-3 pr-3" action="/admin/decor" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input class="form-control" name="name" id="name" required="" placeholder="" value="Decor01">
									@error('name')
										<span class="text-danger">{{ $message }}</span>
									@enderror
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" type="date" name="start_use" id="start_use" required="" placeholder=""
										value="2024-01-01">
									@error('start_use')
										<span class="text-danger">{{ $message }}</span>
									@enderror
								...
								<div class="form-group">
									...
									<input class="form-control" type="date" name="end_use" id="end_use" required="" placeholder=""
										value="2024-01-01">
									@error('end_use')
										<span class="text-danger">{{ $message }}</span>
									@enderror
