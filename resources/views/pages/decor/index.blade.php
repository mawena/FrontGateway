					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex align-items-center mb-4">
								...
								<div class="ml-auto">
									@can(['create'], 'decor', session('userData'))
											...
											<tr class="py-0 text-center">
												...
												<td class="" style="max-width: 100px">
													@can(['read'], 'decor', session('userData'))
														<a href="{{ route('admin.decor.show', $decor['id']) }}" class="btn text-primary"><i
																class="fa fa-eye"></i></a>
													@endcan
													@can(['edit'], 'decor', session('userData'))
														<a href="{{ route('admin.decor.edit', $decor['id']) }}" type="button" class="btn text-warning"><i
																class="fa fa-edit"></i></a>
													@endcan
													@can(['delete'], 'decor', session('userData'))
														<form action="{{ route('admin.decor.destroy', $decor['id']) }}" method="POST"
						...
						<div class="modal-body">
							...
							<form class="pl-3 pr-3" action="/admin/decor" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input class="form-control" type="datetime-local" name="start_use" id="start_use" required=""
										placeholder="" value="2024-12-07T14:30">
									@error('start_use')
										<span class="text-danger">{{ $message }}</span>
									@enderror
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" type="datetime-local" name="end_use" id="end_use" required=""
										placeholder="" value="2024-12-07T22:30">
									@error('end_use')
										<span class="text-danger">{{ $message }}</span>
									@enderror
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" type="file" name="file" id="file" required="" placeholder=""
										value="">
									@error('file')
										<span class="text-danger">{{ $message }}</span>
									@enderror
